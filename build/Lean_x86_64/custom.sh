...
#
sed -i 's#192.168.2.1#10.0.0.1#g' $NET                                                    # 定制默认IP
# sed -i 's#LEDE#OpenWrt-Lean#g' $NET                                                     # 修改默认名称为OpenWrt-Lean
...
CONFIG_PACKAGE_luci-app-lucky=y #DDNS服务
...
CONFIG_PACKAGE_luci-app-openvpnr=y #openvpn服务
